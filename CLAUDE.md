...
- **Copy is the deck's copy.** Slides carry the pitch deck's words. Slide 4 was tightened with the owner's permission, and on 2026-09-05 the owner approved rewriting slide 5's Revenue block and FAQ item 2 to describe the real fee ("1% fee on every buy, taken in the token" / "We hold the same moonbags you do."). Every other slide is verbatim, typos included ("intetion" was fixed only on slide 4).
